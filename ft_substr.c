...
/*   Updated: 2023/11/13 13:22:23 by lkilpela         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 *
	...
	* 2. Handle start index greater than string length: If the start index is 
	greater
 ...
 * 3. Adjust len if it extends beyond the end of the string: If the sum of the
	...
	* start index and the requested length is greater than the length of the 
	string,

	* the function adjusts the length of the substring to go up to the end of 
	the string.
 *

	* 4. Check if memory allocation was successful: If malloc fails to allocate 
	memory
 * for the new string,
	it will return NULL. The function checks for this and returns
 * NULL if allocation failed.
 *

	* 5.Copy the specified substring to the new string: The function uses 
	strlcpy to
 * copy the substring from s to new_str. The strlcpy function takes care of
 * null-terminating the new string.
 * Here, s + start is the source string (the starting point of the substring),
	new_str
 ...
 *
	...
	* This line of code copies len characters from the source string to the 
	destination
 * string,
	and then null-terminates the destination string. This creates the desired
 * substring.
 *
 */