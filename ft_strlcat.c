...
/*   Updated: 2023/11/06 15:34:15 by lumik            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
size_t	ft_strlcat(char * dst, const char *src, size_t dstsize)
{
	...
	size_t copy = min(dstsize - dst_len, src_len + 1);
	if (dst_len < dstsize)
...
* the sum of dst_len and src_len. This is because strlcat assumes that dstsize is 
* the total size of dst, including the null terminator.
*
* If dst_len is less than dstsize, it calculates the minimum of dstsize - dst_len 
* and src_len + 1 and stores it in copy. This is the maximum number of characters 
* that can be copied from src to dst without overflowing dst.
*
* Then, it calls ft_strlcpy to copy copy characters from src to the end of dst.
*
* Finally, it returns the sum of dst_len and src_len, which is the total length that 
