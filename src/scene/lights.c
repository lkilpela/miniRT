...
/*   Updated: 2024/10/03 14:48:46 by lkilpela         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** 5. Light dot normal is the cosine of the angle between the light and the normal
...
t_color	lighting(t_world *w, t_computations comps, t_material *material, bool in_shadow)
{
	...
	adjusted_intensity = multiply_color_by_scalar(w->light.intensity, w->light.brightness);
